...
public class FaceTrackingView extends FrameView {
	...
	public void inBackground(final JPanel mainFrame) throws InterruptedException{
        //
        try {
            int r = FSDK.ActivateLibrary("kOHyhAx3XZilAdfK4dx3j9UoSJq+vlgWphjGAQrQ1p9xpD4Xn18SW6P2unPYX18Bmy+5ZlgwVFxks/eMRMNeqk1aMSx7NNaTpTMGCkNTyXDf20del9xHtQ4DD7FYfDehBRwoUgE2OUAJmpPi+nTvTXJULqKwY8l76KXM2ZQ2Iqg=");
            if (r != FSDK.FSDKE_OK){
        ...
        String[] hardwareID = new String[2];
        ...
        //HCamera hcamera = new HCamera();
        //FSDKCam.OpenVideoCamera("/dev/video0", hcamera);
